...
class AIOT_Admin_Zones {
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        // Enqueue Leaflet for maps from local files
        wp_enqueue_style('leaflet', AIOT_URL . 'assets/lib/leaflet/css/leaflet.css', array(), '1.7.1');
        wp_enqueue_script('leaflet', AIOT_URL . 'assets/lib/leaflet/js/leaflet.js', array(), '1.7.1', true);
        
        // Enqueue Vue.js
        wp_enqueue_script('vue', AIOT_URL . 'assets/lib/vue/vue.js', array(), '2.6.14', true);
        
        // Enqueue animations
        wp_enqueue_style('aiot-animations', AIOT_URL . 'assets/animations/animations.css', array(), AIOT_VERSION);
            ...
            <div class="aiot-modal-content">
                ...
                <div class="aiot-modal-body">
                    <form id="aiot-zone-form">
                        <div class="aiot-form-row">
                            ...
                            <div class="aiot-form-col">
                                ...
                                <select id="zone-type" name="type">
                                    ...
                                    <option value="state"><?php echo esc_html__('State/Province/Governate', 'ai-order-tracker'); ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="aiot-form-row">
                            <div class="aiot-form-col">
                                <label for="zone-delivery-days-min"><?php echo esc_html__('Minimum Delivery Days', 'ai-order-tracker'); ?> *</label>
                                <select id="zone-delivery-days-min" name="delivery_days_min" required>
                                    <?php for ($i = 1; $i <= 20; $i++): ?>
                            ...
                            <div class="aiot-form-col">
                                <label for="zone-delivery-days-max"><?php echo esc_html__('Maximum Delivery Days', 'ai-order-tracker'); ?> *</label>
                                <select id="zone-delivery-days-max" name="delivery_days_max" required>
                                    <?php for ($i = 1; $i <= 100; $i++): ?>
                                        <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                    <?php endfor; ?>
                                </select>
                        ...
                        <div class="aiot-form-row">
                            <div class="aiot-form-col">
                                <label for="zone-processing-days"><?php echo esc_html__('Processing Days', 'ai-order-tracker'); ?> *</label>
                                <select id="zone-processing-days" name="processing_days" required>
                                    <?php for ($i = 1; $i <= 20; $i++): ?>
                                        <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                    <?php endfor; ?>
                                </select>
                            ...
                            <div class="aiot-form-col">
                                <!-- Empty column for 2x2 grid layout -->
                            </div>
                        </div>
