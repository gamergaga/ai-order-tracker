 ...
 * Description: Professional order tracking system with realistic simulation, stylish UI, and comprehensive admin interface. Features direct tracking from courier websites without requiring API keys. Perfect for e-commerce sites looking to provide a premium tracking experience.
 * Version: 2.0.0
 * Author: Your Name
 ...
 * 
 * This plugin is 100% original code developed specifically for this purpose.
 * All courier data is publicly available information used for legitimate tracking purposes.
 * No copyrighted material, trademarks, or proprietary data from third parties is used.
 * Compatible with WordPress coding standards and security best practices.
 */
...
function aiot_create_tables() {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS $couriers_table (
        ...
        supports_domestic tinyint(1) DEFAULT 1,
        created_at datetime DEFAULT CURRENT_TIMESTAMP,
        updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        PRIMARY KEY  (id),
